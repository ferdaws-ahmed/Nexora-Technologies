...
export const servicesData = [
  ...
  },
  {
    ...
    description: "Create stunning, responsive web applications with cutting-edge frameworks and exceptional user experience design.",
    features: ["High-performance web apps", "AI-integrated dashboards", "Responsive design", "PWA development", "E-commerce solutions"],
  ...
  },
  {
    ...
    description: "Enterprise-grade cloud infrastructure for secure, reliable, and infinitely scalable deployments across global platforms.",
    features: ["AWS & Google Cloud setup", "Kubernetes orchestration", "Database optimization", "Disaster recovery", "Cost optimization"],
  ...
  },
  {
    ...
    description: "Develop intelligent control systems for industrial automation and real-time monitoring with edge computing.",
    features: [
  ...
  },
  {
    ...
    description: "Comprehensive security solutions with compliance standards, encryption, and continuous monitoring for peace of mind.",
    features: ["End-to-end encryption", "SOC 2 compliance", "Security audits", "24/7 monitoring", "Incident response"],
