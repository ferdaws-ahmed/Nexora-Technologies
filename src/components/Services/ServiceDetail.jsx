  ...
  return (
    <section className='relative px-4 sm:px-6 lg:px-8 py-20'>
      <div className='max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-12 items-center'>
        ...
        >
          <div className={`absolute inset-0 bg-gradient-to-br ${currentService.color} rounded-2xl blur-3xl opacity-20`}></div>
        ...
        <motion.div
          ...
          transition={{ duration: 0.5 }}
        >
          <h2 className='text-4xl sm:text-5xl font-black text-white mb-4'>{currentService.title}</h2>
          <p className='text-xl text-gray-400 mb-8 leading-relaxed'>{currentService.description}</p>
