...
const FAQ = () => {
  ...
  return (
    <section className='relative bg-black px-4 sm:px-6 lg:px-8 py-20 md:py-32 overflow-hidden border-t border-white/5'>
      {/* Structural Glow */}
      ...
      <div className='container mx-auto max-w-4xl relative z-10'>
        ...
        <div className='text-center mb-12 md:mb-20'>
          ...
          >
            ...
            <span className='text-[10px] md:text-xs font-bold uppercase tracking-[0.3em] text-nexora-teal'>Support</span>
            <div className='w-8 h-px bg-nexora-teal' />
          </motion.div>
          ...
          <motion.h2
            ...
            viewport={{ once: true }}
            className='text-4xl md:text-6xl font-bold text-white mb-6 tracking-tight font-heading'
          >
          ...
          {minimalFaq.map((item, index) => (
            ...
            >
              <button
                ...
                className={`w-full px-6 py-4 md:px-8 md:py-6 text-left transition-all duration-500 rounded-2xl border ${
                  expandedIndex === index
              ...
              >
                ...
                <ChevronDown
                  size={18}
                  className={`shrink-0 transition-all duration-500 ${expandedIndex === index ? "rotate-180 text-nexora-teal" : "text-gray-600"}`}
                />
              </button>
              ...
              <AnimatePresence>
                {expandedIndex === index && (
                  ...
                  >
                    <div className='px-6 py-5 md:px-8 md:py-6 text-gray-400 text-sm md:text-base font-light leading-relaxed border-x border-b border-white/5 rounded-b-2xl -mt-4 bg-white/5'>
                      {item.a}
                    </div>
                  </motion.div>
                )}
