  ...
  return (
    ...
    >
      ...
      >
        ...
        <span className='text-xs font-bold uppercase tracking-[0.3em] text-nexora-teal'>Connect</span>
        <div className='w-8 h-px bg-nexora-teal' />
      </motion.div>

      <h1 className='text-5xl sm:text-6xl lg:text-7xl font-bold text-white mb-8 tracking-tight leading-[1.1]'>
