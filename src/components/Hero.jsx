...
const slides = [
  {
    ...
    description: "Building scalable, high-performance applications tailored for modern enterprises.",
  ...
  },
  {
    ...
    description: "Empowering decision-making with predictive analytics and ethical AI integration.",
  ...
  },
  {
    ...
    description: "Reliable intelligent control systems for smart industrial process automation.",
  ...
  },
  {
    ...
    description: "Scalable and high-integrity cloud solutions for the future digital ecosystem.",
                  ...
                  {activeIndex === index && (
                    <div className="max-w-3xl">
                      ...
                      >
                        ...
                        >
                          <Link href="/services" className="btn btn-primary btn-sm md:btn-md lg:btn-lg rounded-full px-6 md:px-10 text-white border-none shadow-lg">
                            Explore
                          </Link>
                          <Link href="/contact" className="btn btn-outline btn-sm md:btn-md lg:btn-lg rounded-full px-6 md:px-10 text-white border-white/40">
                            Get Quote
                          </Link>
                        </motion.div>
                      </motion.div>
