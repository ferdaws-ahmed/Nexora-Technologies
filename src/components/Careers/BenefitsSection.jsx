...
export default function BenefitsSection() {
  return (
    <section className='px-4 sm:px-6 lg:px-8 py-16 bg-slate-800/30'>
      <h2 className='text-3xl sm:text-4xl font-bold text-white text-center mb-12'>Why Work at NEXORA?</h2>
      <div className='max-w-6xl mx-auto grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6'>
        {benefits.map((b, idx) => (
          ...
          >
            <div className='mb-3 flex items-center justify-center'>{b.icon}</div>
